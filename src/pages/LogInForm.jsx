  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-blue-100 dark:bg-gray-900">
      <div className="bg-white dark:bg-gray-800 p-8 shadow-2xl rounded-3xl w-full max-w-md mx-4 sm:mx-auto mt-20 mb-10">
        <h2 className="text-2xl text-cyan-600 dark:text-cyan-400 font-bold mb-6 text-center">Login</h2>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            <Link to="/signup" className="text-cyan-500 dark:text-cyan-400 hover:underline">
              Create an account
            </Link>
          </p>
          <p className="text-sm text-gray-600 dark:text-gray-400">
            <Link to="/forgot-password" className="text-cyan-500 dark:text-cyan-400 hover:underline">
              Forgot password?
            </Link>
          </p>
        </div>
